...
interface DeleteQuestionTypeProps {
    id: number
    name: string
    refetch: () => void
}

const DeleteQuestionType = ({ id, name, refetch }: DeleteQuestionTypeProps) => {
                ...
                <ModalBody>
                    <div className='text-center'>
                        ...
                        <h3 className='mb-5 text-lg font-normal text-gray-500 dark:text-gray-400'>
                            Are you sure you want to delete <b>{name}</b> question type?
                        </h3>
...
export default DeleteQuestionType
