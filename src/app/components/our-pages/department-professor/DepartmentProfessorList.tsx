...
import AddDepartmentProfessor from "./AddDepartmentProfessor";
import EditDepartmentProfessor from "./EditDepartmentProfessor";
import DeleteDepartmentProfessor from "./DeleteDepartmentProfessor";
...
function DepartmentProfessorList() {
  ...
  const professorId: number | null =
    professorIdParam && !isNaN(Number(professorIdParam))
      ? Number(professorIdParam)
      : null;
  ...
  // UI: helper to render sort icons (same pattern as other lists)
  ...
  return (
    <div>
      <TitleCard title="Department Professor List">
        <section className="flex w-full justify-between items-center gap-4">
          ...
          <AddDepartmentProfessor refetch={noop} />
        </section>
                    ...
                    <TableRow key={row.id}>
                      ...
                      <TableCell>
                        <div className="flex justify-center items-center gap-2">
                          <EditDepartmentProfessor studentCourseID={item.id} onSuccess={noop} />
                          <DeleteDepartmentProfessor id={item.id} name={item.course?.title} refetch={noop} />
                        </div>
                      </TableCell>
                    </TableRow>
                  );
...
export default DepartmentProfessorList;
