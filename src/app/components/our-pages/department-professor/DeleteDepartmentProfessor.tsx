...
import { deleteStudentCourse } from '@/app/router/student-courses.router'
import { Icon } from '@iconify/react'

interface DeleteStudentCourseProps {
    id: number
    name: string
    refetch: () => void
}

const DeleteDepartmentProfessor = ({ id, name, refetch }: DeleteStudentCourseProps) => {
                ...
                <ModalBody>
                    <div className='text-center'>
                        ...
                        <h3 className='mb-5 text-lg font-normal text-gray-500 dark:text-gray-400'>
                            Are you sure you want to delete <b>{name}</b> student course?
                        </h3>
...
export default DeleteDepartmentProfessor
