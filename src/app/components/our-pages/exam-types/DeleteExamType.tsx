...
import { deleteExamType } from '@/app/router/exam-type.router'
...
const DeleteExamType = ({ id, name, refetch }: DeleteExamTypeProps) => {
                ...
                <ModalBody>
                    <div className='text-center'>
                        ...
                        <h3 className='mb-5 text-lg font-normal text-gray-500 dark:text-gray-400'>
                            Are you sure you want to delete <b>{name}</b> exam type?
                        </h3>
