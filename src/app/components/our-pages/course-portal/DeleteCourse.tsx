...
import { deleteCourse } from '@/app/router/course.router'
...
const DeleteCourse = ({ id, title, refetch }: DeleteCourseProps) => {
        ...
        <ModalBody>
          <div className='text-center'>
            ...
            <h3 className='mb-5 text-lg font-normal text-gray-500 dark:text-gray-400'>
              Are you sure you want to delete the course <b>{title}</b>?
            </h3>
