...
import { deleteDepartment } from '@/app/router/department.router'
...
const DeleteDepartment = ({ id, name, refetch }: DeleteDepartmentProps) => {
                ...
                <ModalBody>
                    <div className='text-center'>
                        ...
                        <h3 className='mb-5 text-lg font-normal text-gray-500 dark:text-gray-400'>
                            Are you sure you want to delete <b>{name}</b> department?
                        </h3>
