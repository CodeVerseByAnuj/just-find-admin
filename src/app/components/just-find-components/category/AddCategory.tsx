...
import { createCategory } from '@/app/router/category.router'
...
const AddCategory = ({ refetch, buttonWidth }: AddCategoryProps) => {
  ...
  return (
    <div>
      ...
      <Modal show={formModal} size='md' onClose={onCloseModal} popup>
        <ModalHeader className='p-6'>Add Category</ModalHeader>
        <ModalBody>
