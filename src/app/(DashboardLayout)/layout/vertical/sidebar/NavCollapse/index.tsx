  ...
  return (
    <>
      <SidebarCollapse
        ...
        className={activeDD ? 'text-white! child bg-primary rounded-xl hover:bg-primary hover:text-white shadow-btnshdw' : ' rounded-xl dark:text-white/80 hover:text-primary hover:bg-transparent dark:!bg-transparent'}
